...
function renderArticle(articulos) {
  ...
  var html = '<article class="single-article" style="background: white; padding: 30px; border-radius: 5px; box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.5);">' +
    ...
    (articulo.informacion ? '<a href="' + articulo.informacion + '" target="_blank" rel="noopener" style="display: block; margin-top: 25px; padding: 15px; background: #f0f8fb; border-left: 4px solid rgb(6, 147, 194); border-radius: 3px; font-family: \'Josefin Sans\', sans-serif; text-decoration: none; color: inherit; transition: background 0.2s;" onmouseover="this.style.background=\'#e0f0f5\'" onmouseout="this.style.background=\'#f0f8fb\'">' +
      ...
      '<span style="color: rgb(6, 147, 194); word-break: break-all;">' + articulo.informacion + '</span>' +
    '</a>' : '') +
